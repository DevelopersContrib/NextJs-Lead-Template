...
export default async function TopDomainsComponent() {
          ...
          <div className="col-xl-12">
            ...
            >
              {domains.data.domains.map((domain) => 
                ...
                <a href={domain.brand_link} className='tw-no-underline tw-inline-block'>
                  <Image
                    src={domain.logo}
                    width={0}
                    height={0}
                ...
                <div className='text-center tw-space-x-2 w-100'>
                  <a href={domain.site_link} className="btn btn-success">Visit</a>
                  <a href={domain.brand_link} className="btn btn-success">Details</a>
                </div>
              </SwiperSlide>
              )}
            </Swiper>
